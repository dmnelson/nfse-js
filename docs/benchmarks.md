...
Benchmarks are diagnostic, not CI pass/fail thresholds. Record Node version,
hardware, package commit, iterations, and representative document shape before
using results for capacity planning. Network and SEFIN latency are deliberately
excluded.
